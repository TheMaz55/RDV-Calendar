document.addEventListener('DOMContentLoaded', function() {
  ...
  var calendar = new Calendar(calendarEl, {
    ...
    openPopup("backgroundContenuEvenementPreset");
    console.log(info.event.startStr+" 00:00:00");
    $(".debutPreset").val(info.event.startStr+" 00:00:00");
    $(".titlePreset").val(info.event.title);
    },
